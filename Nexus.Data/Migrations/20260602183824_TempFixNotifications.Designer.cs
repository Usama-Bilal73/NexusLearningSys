...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexus.Data.Models.CourseMaterial", b =>
                {
                    ...
                    b.Property<DateTime?>("SummarizedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("UploadedByTeacherId")
                        .IsRequired()
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Nexus.Data.Models.Grade", b =>
                {
                    ...
                    b.Property<decimal>("MidtermMarks")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("Nexus.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Nexus.Data.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nexus.Data.Models.Answer", b =>
                {
                    b.HasOne("Nexus.Data.Models.Question", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Nexus.Data.Models.QuizAttempt", "QuizAttempt")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Nexus.Data.Models.CourseMaterial", b =>
                {
                    ...
                    b.HasOne("Nexus.Data.Identity.ApplicationUser", "UploadedByTeacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Nexus.Data.Models.Notification", b =>
                {
                    b.HasOne("Nexus.Data.Identity.ApplicationUser", "RecipientUser")
                        .WithMany()
                        .HasForeignKey("RecipientUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nexus.Data.Identity.ApplicationUser", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Nexus.Data.Models.Question", b =>
                {
                    b.HasOne("Nexus.Data.Models.Quiz", "Quiz")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Nexus.Data.Models.Submission", b =>
                {
                    b.HasOne("Nexus.Data.Models.Assignment", "Assignment")
