...
public class StudentsController : Controller
{
    ...
    {
        var usersInRole = await _userManager.GetUsersInRoleAsync(ApplicationRoles.Student);
    ...
    public async Task<IActionResult> DeleteConfirmed(string id)
    {
        ...
        TempData["Success"] = "Student account deleted successfully.";
        return RedirectToAction(nameof(Index));
    }

    private async Task<bool> IsInManagedRoleAsync(ApplicationUser user) => await _userManager.IsInRoleAsync(user, ApplicationRoles.Student);
